...
app.get("/sign_up", function(req, res) {
  fs.readFile('./routes/sign_up.html', "utf-8", function(err, data) {
    res.send(data);
  });
});
...
app.get("/board", function(req, res) {
  fs.readFile('./routes/board.html', "utf-8", function(err, data) {
...
app.get("/add", function(req, res) {
  fs.readFile('./routes/add.html', "utf-8", function(err, data) {
    res.send(data);
  });
});
...
app.get("/space/:id", function(req, res) {
  fs.readFile("./routes/space.html", "utf8", function(err, data) {
...
app.get("/delete/:id", function(req, res){
  fs.readFile('./routes/delete.html', "utf8", function(err, data) {
    db.query("select * from board where board_no = ?", [req.params.id], function(err, result) {
      if(err){
        console.log(err);
      }
